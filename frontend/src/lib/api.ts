...
export const objectsApi = {
  ...
  getTemplates: async () => {
    ...
    const defaultTemplates: { [key: string]: InfraObject[] } = {
      ...
      solar: [
        { id: 'canopy-qatar-100mw', name: 'Canopy Solaire Qatar 100MW', type: 'solar-canopy', dimensions: { width: 42000, height: 2000, depth: 24000 }, color: '#1e3a5f', description: '8 containers (2×4) - 42m×24m - 8 ouvertures extraction thermique' },
        { id: 'canopy-4-containers', name: 'Canopy Solaire 4 Containers', type: 'solar-canopy', dimensions: { width: 22000, height: 2000, depth: 24000 }, color: '#1e3a5f', description: '4 containers (1×4) - 22m×24m - 4 ouvertures extraction' },
